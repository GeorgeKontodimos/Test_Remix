...
contract learnFunctions {
   ...
   /* int x, y ; */
      ...
      function _add() public view returns(uint){ //this fucntion is a private function
        uint x =5;
        uint y =6;
        uint z = x + y;
        return z;
       }
        function _multi(uint x,uint y) public view returns(uint){ //this fucntion is a private function
            uint result = x * y;
        return result;
     }
}
